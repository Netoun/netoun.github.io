...
export function ComputerSection() {
  ...
  return (
    <section className={computerSection}>
      <div className={computerWrapperBaseSection} style={{ transform: `scale(${scale})` }}>
        <div
          ...
          <div className={computerSettingsSection} key={group.title}>
            ...
            {group.controls.map((control) => (
              <div className={computerSettingsLabel} key={control.label}>
                <span className={computerSettingsLabelTitle}>{control.label}</span>
                <Slider
                ...
                />
                <span className={computerSettingsValue}>{control.formatValue(control.value)}</span>
              </div>
            ))}
          </div>
        ))}
