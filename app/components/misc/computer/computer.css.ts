...
export const computerFrameLidBackStyle =
	lidFaceWithBackground('translateZ(-10px)');
...
export const computerFrameChassisStyle = style([
	baseFrameStyle,
	{
		...
		top: '33%',
		transform:
			'rotateY(-45deg) rotateX(90deg) translateX(-10px) translateY(55%)',
...
export const computerFrameChassisBackStyle =
	chassisFaceWithBackground('translateZ(-10px)');
